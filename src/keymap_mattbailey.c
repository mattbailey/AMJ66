...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     * |----------------------------------------------------------|  `---'
     * |RCtrl |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|   Ent |
     * |-------------------------------------------------------------.
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift|Fn | UP|
     * |-----------------------------------------------------------------.
     * |LCTL |LALT |LGUI|       Space           |RGUI |RALT | Fn |LFT|DWN|RIG|
     * `-----------------------------------------------------------------'
     */
    KEYMAP(
        ...
        LSFT,  NO,  Z,   X,   C,   V,   B,   N,   M,   COMM, DOT, SLSH, RSFT,FN0, UP,\
        LCTL,LALT,LGUI,NO,      SPC,                     RGUI,RALT, FN0, LEFT, DOWN, RGHT),
    /* Keymap 1: FN Layer
     * ,----------------------------------------------------------.  ,---.
     ...
     */
    KEYMAP(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL, TRNS, PGUP,\
        TRNS,TRNS,UP,  TRNS,TRNS,TRNS,CALC,TRNS,INS, TRNS,PSCR,SLCK,PAUS,TRNS,      PGDN, \
        ...
        TRNS,TRNS,TRNS,TRNS,          TRNS,                    TRNS,TRNS,TRNS,HOME,TRNS,END)
};
